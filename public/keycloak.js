...
var keycloak = (0, keycloak_js_1.default)({
    url: 'https://keycloak.locatiereserveren.quest',
    realm: 'ReserveringRealm',
    clientId: 'locatiereserveren-webapp'
});
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var authenticated, parsed, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, keycloak.init({ onLoad: 'login-required' })];
            case 1:
                ...
                if (!authenticated) {
                    ...
                    console.log("Ingelogd als:", (_a = parsed === null || parsed === void 0 ? void 0 : parsed.preferred_username) !== null && _a !== void 0 ? _a : 'Onbekend');
                    window.dispatchEvent(new Event('authenticated'));
                }
                return [3 /*break*/, 3];
            case 2:
                error_1 = _b.sent();
                console.error("Keycloak init mislukt:", error_1);
                return [3 /*break*/, 3];
...
setInterval(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, keycloak.updateToken(60)];
            case 1:
                refreshed = _b.sent();
                if (refreshed) {
